...
app.get('/article/delete/:id', checkAdmin, articleController.delete, redirectBack);
app.get('/article/update/:id', checkAdmin, articleController.update, redirectBack);
app.post('/article/update/:id', checkAdmin, articleController.handleUpdate, redirectBack);

// 分類系統
app.get('/category/list', categoryController.list, redirectBack);
app.post('/category/list', checkAdmin, categoryController.handleAdd, redirectBack);
app.get('/category/delete/:id', checkAdmin, categoryController.delete, redirectBack);
app.get('/category/update/:id', checkAdmin, categoryController.update);
app.post('/category/update/:id', checkAdmin, categoryController.handleUpdate, redirectBack);
